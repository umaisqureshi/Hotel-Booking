...
import 'package:hotel_booking/data/local/local_database.dart' as _i7;
import 'package:hotel_booking/data/remote/api_service.dart' as _i5;
import 'package:hotel_booking/data/repository/hotels_data_source.dart' as _i4;
import 'package:hotel_booking/data/repository/hotels_local_datasource.dart'
    as _i6;
import 'package:hotel_booking/data/repository/hotels_repository.dart' as _i8;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt initGetIt({
    ...
    gh.factory<_i6.HotelsLocalDatasource>(() => _i7.LocalDatabaseService());
    gh.factory<_i8.HotelsRepository>(() => _i8.HotelsRepository(
          hotelsDataSource: gh<_i4.HotelsDataSource>(),
          localDataSource: gh<_i6.HotelsLocalDatasource>(),
        ));
    gh.factory<_i9.OverviewBloc>(() => _i9.OverviewBloc());
    gh.factory<_i10.RemoveFavoriteUseCase>(() =>
        _i10.RemoveFavoriteUseCase(repository: gh<_i8.HotelsRepository>()));
    gh.factory<_i11.AddToFavoriteUseCase>(() =>
        _i11.AddToFavoriteUseCase(repository: gh<_i8.HotelsRepository>()));
    gh.factory<_i12.GetAllFavoritesUseCase>(() =>
        _i12.GetAllFavoritesUseCase(repository: gh<_i8.HotelsRepository>()));
    gh.factory<_i13.GetHotelsUseCase>(
        () => _i13.GetHotelsUseCase(repository: gh<_i8.HotelsRepository>()));
    ...
    gh.factory<_i15.FavoriteBloc>(() => _i15.FavoriteBloc(
          ...
          removeFavoriteUseCase: gh<_i10.RemoveFavoriteUseCase>(),
        ));
    return this;
  }
}
